# Sorting Day 2 - Counting and Radix Sort
...
You are given an array of integers between [-100, 100], inclusive. Write a function to sort them as quickly as possible. Feel free to use code you've already written.
